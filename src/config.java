class Config{
	public static int[][] grassPosition = {
		{ 2, 2 }, { 2, 3 }, { 2, 4 }, { 2, 5 },
		{ 3, 2 }, { 3, 3 }, { 3, 4 }, { 3, 5 },
		...
		{ 11, 2 }, { 11, 3 }, { 11, 4 }, { 11, 5 }, { 11, 10 }, { 11, 11 }, { 11, 12 }, { 11, 14 }, { 11, 15 }, { 11, 16 }, { 11, 17 },
		{ 12, 15 }, { 12, 22 }, { 12, 23 }, { 12, 24 }, { 12, 25 },
		{ 13, 15 }, { 13, 22 }, { 13, 23 }, { 13, 24 }, { 13, 25 },
		{ 14, 24 }, { 14, 25 },
		{ 15, 24 }, { 15, 25 },
	...
	public static int[][] brickPosition = {
	...
	public static int[][] steelPosition = {
		{ 6, 2 }, { 6, 3 }, { 6, 24 }, { 6, 25 },
		{ 7, 2 }, { 7, 24 }, { 7, 25 },
		{ 8, 12 }, { 8, 13 }, { 8, 20 },
		{ 9, 20 },
	...
	public static int initEnemyCount = 4;
	public static int initEnemyHealth = 2;
	public static int initPlayerHealthPvP = 100;
	public static int initPlayerHealthPvE = 4;
	public static int enemyNumGain = 2; // increse enemy every stage passed
 	public static int playerHpGain = 2; // increse player hp every stage passed
}
